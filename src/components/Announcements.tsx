...
const Announcements = () => {
  ...
  return (
    <div className="px-4 lg:px-16 py-8 lg:py-12 mb-8 lg:mb-16 -mt-24 lg:-mt-32 relative z-10">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 justify-items-end">
        {announcements.map((announcement) => (
          <Card key={announcement.id} className="bg-card/50 backdrop-blur-sm border-border/50 w-full">
